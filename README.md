# JavaScript Web Design Playground
...
- **Item-based splitting**: Enter the item name, cost, and select who shared it — the app calculates each person’s share automatically.
- **Instant recalculation / undo**: Entries can be reversed easily if mistakes are made.
- **Keyboard-friendly**: Fully operable using only the keyboard for faster and more efficient usage.
- **Responsive design**: Works on both **desktop and mobile devices** (optimized for desktop experience).
- **Clean and friendly interface**: Simple layout to keep focus on what matters — splitting the bill.
